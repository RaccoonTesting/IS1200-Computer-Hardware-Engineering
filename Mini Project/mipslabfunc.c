...
void mat_box (int mat_stage){
    if(mat_stage == 1){
        show_lev(27,22); /*foodlevelbit längst ned*/
        show_lev(27,15); /*foodlevelbit i mitten*/
        show_lev(27,8); /*foodlevelbit längst upp*/
    }
    if(mat_stage == 2){
        show_lev(27,22); /*foodlevelbit längst ned*/
        show_lev(27,15); /*foodlevelbit i mitten*/
...
void sleep_box (int sleep_stage){
    if(sleep_stage == 1){
        show_lev(3,22); /*sleeplevelbit längst ned*/
        show_lev(3,15); /*sleeplevelbit i mitten*/
        show_lev(3,8); /*sleeplevelbit längst upp*/
    }
    if(sleep_stage == 2){
        show_lev(3,22); /*sleeplevelbit längst ned*/
        show_lev(3,15); /*sleeplevelbit i mitten*/
...
void clean_box (int clean_stage){
    if(clean_stage == 1){
        show_lev(19,22); /*pooplevelbit längst ned*/
        show_lev(19,15); /*pooplevelbit i mitten*/
        show_lev(19,8); /*pooplevelbit längst upp*/
    }
    if(clean_stage == 2){
        show_lev(19,22); /*pooplevelbit längst ned*/
        show_lev(19,15); /*pooplevelbit i mitten*/
...
void fun_box (int fun_stage){
    if(fun_stage == 1){
        show_lev(11,22); /*heartlevelbit längst ned*/
        show_lev(11,15); /*heartlevelbit i mitten*/
        show_lev(11,8); /*heartlevelbit längst upp*/
    }
    if(fun_stage == 2){
        show_lev(11,22); /*heartlevelbit längst ned*/
        show_lev(11,15); /*heartlevelbit i mitten*/
